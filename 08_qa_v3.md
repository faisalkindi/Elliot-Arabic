...
Rows checked: **4287**  |  Total issues: **31**

## [CRITICAL] Added/extra placeholders — 4
...
## [MEDIUM] Glossary term not applied — 1

| ID | Detail |
|----|--------|
| EL_M05_A2MGC_E03_1100_M090_PCM000_m | 'ライトスタッフ' expected 'لايت ستاف' |
...
| EL_SYSTEM_Tutorial | 64 chars (>28) |
